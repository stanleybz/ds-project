...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        fig = px.pie(spacex_df, names='Launch Site', title=f'Total Success Launch By Site')
    else:
...
def update_scatter_chart(selected_site, payload_range):
    if selected_site == 'ALL':
        # If 'All Sites' is selected, create a scatter plot for all sites
        filtered_df = spacex_df
    else:
        # If a specific site is selected, filter the DataFrame
    ...
    # Create a scatter plot with Payload Mass (kg) on the x-axis, class on the y-axis, and color-coded by Booster Version Category
